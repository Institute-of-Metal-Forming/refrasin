...
public static class RingItemExtensions
{
    ...
    public static void Remove<TRingItem>(this TRingItem self)
    ...
    public static void Replace<TRingItem>(this TRingItem self, TRingItem replacement)
        where TRingItem : class, IRingItem<TRingItem>
    {
        if (self.Ring != null)
    ...
    public static void InsertAbove<TRingItem>(this TRingItem self, TRingItem insertion)
        where TRingItem : class, IRingItem<TRingItem>
    {
        if (self.Ring != null)
    ...
    /// <param name="self"></param>
    /// <param name="insertion"></param>
    public static void InsertBelow<TRingItem>(this TRingItem self, TRingItem insertion)
        where TRingItem : class, IRingItem<TRingItem>
    {
        if (self.Ring != null)
    ...
    /// </exception>
    public static bool IsRingMember<TRingItem>(this TRingItem self)
        where TRingItem : class, IRingItem<TRingItem>
    {
        if (self.Ring != null)
        {
            if (
                self.Upper != null
                && self.Lower != null
                && self.Upper.Ring == self.Ring
                && self.Lower.Ring == self.Ring
            )
                return true;

            throw new InvalidOperationException(
                "This object is member of a ring, but has no valid neighbors. Something seems broken."
            );
        }
        ...
        throw new InvalidOperationException(
            "This object is no member of a ring, but has neighbors. Something seems broken."
        );
    }
    ...
    /// </remarks>
    public static bool IsMemberOf<TRingItem>(this TRingItem self, Ring<TRingItem> ring)
        where TRingItem : class, IRingItem<TRingItem> =>
